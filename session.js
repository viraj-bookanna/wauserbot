...
let excludedDir = [
  "session-wauserbot/Default/Cache",
  "session-wauserbot/Default/Code Cache",
  "session-wauserbot/Default/Code Storage",
  "session-wauserbot/Default/blob_storage",
  "session-wauserbot/Default/Service Worker",
];
...
module.exports = {
  ...
  replicate: async function replicate() {
    try {
      setPassword(getCipherKey(process.env.SESSION_PASSWORD));
      await new Promise((resolve) => {
